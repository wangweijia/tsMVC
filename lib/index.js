(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reflect-metadata'), require('dayjs')) :
    typeof define === 'function' && define.amd ? define(['exports', 'reflect-metadata', 'dayjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.uodule = {}, null, global.dayjs));
})(this, (function (exports, reflectMetadata, dayjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ModelBaseClassRoot = /** @class */ (function () {
        ...
        // 初始化 树状路径
        ModelBaseClassRoot.prototype._init_path_ = function (basePath, pathName) {
            if (basePath === void 0) { basePath = []; }
            return __spreadArray([], basePath, true);
        };
        // 树状数据 展开成 列表数据
        ModelBaseClassRoot.prototype._tree_to_list_ = function (baseList, pathName) { };
