...
exports.ModelEnter = exports.ModelAutoUUID = exports.ModelCol = exports.ModelBaseClass = void 0;
...
class ModelBaseClass extends ModelBaseClassRoot {
    _OTD_() {
        return {};
    }
    static InitWithList(items) {
                                ...
                                try {
                                    ...
                                    if (!config.type || config.type === 'single') {
                                        ...
                                        if (tempConfig.formatDTOKey) {
                                            this[propsKey] = (0, dayjs_1.default)(value).format(tempConfig.formatDTOKey);
                                        }
                                        else {
                                            this[propsKey] = value;
                                        }
                            ...
                            try {
                                if (!config.type || config.type === 'single') {
                                    ...
                                    if (tempConfig.formatOTDKey) {
                                        data[dataKey] = (0, dayjs_1.default)(value).format(tempConfig.formatOTDKey);
                                    }
                                    else {
                                        data[dataKey] = value;
                                    }
