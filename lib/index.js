(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('reflect-metadata'), require('dayjs'), require('dayjs/plugin/customParseFormat.js')) :
    typeof define === 'function' && define.amd ? define(['exports', 'reflect-metadata', 'dayjs', 'dayjs/plugin/customParseFormat.js'], factory) :
    ...
    ***************************************************************************** */
    ...
    function convertCamelToUnderlineFun(str) {
    ...
    var ModelBaseClass = /** @class */ (function (_super) {
        ...
        ModelBaseClass.prototype._init_path_ = function (basePath, pathName) {
            return [];
        };
                        ...
                        (_this._baseKeys || []).forEach(function (propsKey) {
                            ...
                            var key = config.key
                                ...
                                : opt.convertCamelToUnderline
                                    ...
                                    : propsKey;
                            var baseKey = config.key ? config.key : propsKey;
                            customLog("key:", key);
                            if (props) {
                                var formatValue = config.formatValue;
                                // 获取原始 数据
                                var value = (_a = props[key]) !== null && _a !== void 0 ? _a : props[baseKey];
                                // 如果有格式化方法，格式化数据
                                if (formatValue) {
